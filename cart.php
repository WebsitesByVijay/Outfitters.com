                ...
                <form action="" method="post" class="box">
                    ...
                    <div class="flex">
                        ...
                        <input type="number" name="qty" class="qty" min="1" max="99"
                            ...
                            value="<?= $fetch_cart['quantity']; ?>" oninput="updateTotal(this);"
                            data-price="<?= $fetch_cart['price']; ?>">
                        <button type="submit" class="fas fa-edit" name="update_qty"></button>
                    </div>
                    <div class="sub-total"> sub total :
                        <span>$<?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span>
                    </div>
                    <input type="submit" value="delete item" onclick="return confirm('Delete this from your cart?');"
